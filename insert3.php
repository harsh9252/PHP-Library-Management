...
if(isset($_REQUEST['save']))
{
    ...
    $harsh="insert into Members (id,name,join_date,period,email) values($id,'$name',$join_date,$period,'$email')";
...
<body>
   ...
   <div class="container">
    <div class="row">
        ...
        <div class="col-6">
            <label  class="form-label">Enter Your Join date</label>
...
<div class="collapse" id="collapseExample" id="hide">
  ...
  <?php require_once "card3.php"; ?>
  </div>
</div></center>
<!-- Button trigger modal -->
<!-- <center><button type="button" class="btn btn-primary mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal">
Show Data
</button></center> -->
