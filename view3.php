...
if(isset($_GET['edit']))
{
    ...
    $harsh="SELECT  * FROM Members  WHERE id='$id'";
    ...
    <div class="row">
        ...
        <div class="col-6">
            <label  class="form-label">Enter Join Date</label>
             <input type="text" class="form-control"  readonly  name="join_date" value=<?php echo $m ?>>
        </div>

        <div class="col-6">
            <label  class="form-label">Enter Period </label>
            <input type="text" class="form-control"  readonly  name="period" value=<?php echo $s ?>>
        </div>

        <div class="col-6">
             <label  class="form-label">Enter Email id</label>
             <input type="text" class="form-control" readonly  name="email" value=<?php echo $e ?>>
        </div>
